...
- preloading מדיה כש-scene הוא ה"הבא" (ראו §15.4)
...
(היחיד עם ברירת "פסיכית"/עמוסה — opt-in בלבד, §4.7). כל פריסט עובר
בדיקת ניגודיות אוטומטית (`lib/contrast.ts`) לפני שהוא מוצג כאופציה.
